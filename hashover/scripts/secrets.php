<?php
	...
	$encryption_key		= 'enckey123';			// Unique 8 to 32 character encryption key
	$notification_email	= 'dean_matt@network.lilly.com';	// E-mail for notification of new comments
	$admin_nickname		= 'administrator';			// Nickname with admin rights (must be title-cased)
